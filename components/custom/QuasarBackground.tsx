...
export const QuasarBackground = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#030308] flex items-center justify-center">
      ...
      <div className="absolute w-[28vw] h-[28vw] max-w-[280px] max-h-[280px] rounded-full bg-black shadow-[inset_0_0_20px_rgba(0,0,0,1)] z-0" />
